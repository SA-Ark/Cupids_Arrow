...
class UserForm(FlaskForm):
  ...
  ethnicity = SelectField('Ethnicity', choices=[('Asian', 'Asian'), ('Black', 'Black'), ('Hispanic/Latin', 'Hispanic/Latin'), ('Indian', 'Indian'), ('Middle Eastern', 'Middle Eastern'), ('Native American', 'Native American'), ('Pacific Islander', 'Pacific Islander'), ('White', 'White'), ('Other ethnicity', 'Other ethnicity')])
  ...
  inibriates = BooleanField('Inibriates')
