...
//     const likesme = useSelector(state=>state.likes.likesme)
//     const mylikes = useSelector(state=>state.likes.mylikes)
...
//     useEffect(() => {
//         dispatch(fetchUnliked()).then(()=> dispatch(fetchLikes()))
//         // dispatch(fetchLikes())
//     }, [])
...
//     })
//     // let likesmelist
//     const likesmelist = Object.keys(likesme).map((id) => console.log(likesme) && <SmallProfile theuser={likesme[id]} />)
