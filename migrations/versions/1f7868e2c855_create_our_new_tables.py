...
Revision ID: 1f7868e2c855
Revises: 
Create Date: 2023-01-13 22:47:36.467455
...
def upgrade():
    ...
    sa.Column('answer_choices', sa.Boolean(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('user_id', 'question_id', 'answer_id')
    )
    op.create_table('user_likes',
    sa.Column('parent_id', sa.Integer(), nullable=True),
    sa.Column('children_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['children_id'], ['users.id'], ),
