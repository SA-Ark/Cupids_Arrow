...
Revision ID: 84cde3d2b40e
Revises: 
Create Date: 2023-01-15 22:24:25.013445
...
def upgrade():
    ...
    sa.Column('user_answers_id', sa.Integer(), nullable=False),
    sa.Column('answer', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.Date(), nullable=True),
    sa.ForeignKeyConstraint(['question_id'], ['questions.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('user_id', 'question_id', 'user_answers_id')
    )
